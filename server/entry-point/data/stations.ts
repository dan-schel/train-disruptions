...
const data = [
  ...
  new Station({
    id: station.BLACKBURN,
    name: "Blackburn",
    ptvIds: [1023],
    mapLocation: corridor.camberwellToRingwood.pointAt(7, 11),
  }),
  new Station({
    id: station.BONBEACH,
    name: "Bonbeach",
  ...
  new Station({
    ...
    name: "Box Hill",
    ptvIds: [1026],
    mapLocation: corridor.camberwellToRingwood.pointAt(5, 11),
  }),
  new Station({
  ...
  new Station({
    id: station.BROADFORD,
    name: "Broadford",
    ptvIds: [1511],
    mapLocation: corridor.craigieburnToSeymour.pointAt(6, 8),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Bunyip",
    ptvIds: [1512],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(4, 16),
  }),
  new Station({
    id: station.BURNLEY,
    name: "Burnley",
    ptvIds: [1030],
    mapLocation: MapPoint.at(node.BURNLEY.BURNLEY),
  }),
  new Station({
    id: station.BURWOOD,
    name: "Burwood",
  ...
  new Station({
    id: station.CAMBERWELL,
    name: "Camberwell",
    ptvIds: [1032],
    mapLocation: MapPoint.at(node.BURNLEY.CAMBERWELL),
  }),
  new Station({
  ...
  new Station({
    id: station.CANTERBURY,
    name: "Canterbury",
    ptvIds: [1033],
    mapLocation: corridor.camberwellToRingwood.pointAt(2, 11),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Carnegie",
    ptvIds: [1034],
    mapLocation: corridor.caulfieldToClayton.pointAt(1, 6),
  }),
  new Station({
  ...
  new Station({
    id: station.CASTLEMAINE,
    name: "Castlemaine",
    ptvIds: [1514],
    mapLocation: corridor.sunburyToBendigo.pointAt(8, 10),
  }),
  new Station({
    id: station.CAULFIELD,
    name: "Caulfield",
    ptvIds: [1036],
    mapLocation: MapPoint.between(
  ...
  new Station({
    ...
    name: "Chatham",
    ptvIds: [1037],
    mapLocation: corridor.camberwellToRingwood.pointAt(3, 11),
  }),
  new Station({
    id: station.CHELSEA,
    name: "Chelsea",
  ...
  new Station({
    id: station.CLARKEFIELD,
    name: "Clarkefield",
    ptvIds: [1516],
    mapLocation: corridor.sunburyToBendigo.pointAt(1, 10),
  }),
  new Station({
    id: station.CLAYTON,
    name: "Clayton",
  ...
  new Station({
    ...
    name: "Clifton Hill",
    ptvIds: [1041],
    mapLocation: MapPoint.at(node.CLIFTON_HILL.CLIFTON_HILL),
  }),
  new Station({
    id: station.CLUNES,
    name: "Clunes",
    ptvIds: [1591],
    mapLocation: corridor.ballaratToMaryborough.pointAt(2, 4),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Creswick",
    ptvIds: [1590],
    mapLocation: corridor.ballaratToMaryborough.pointAt(1, 4),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Donnybrook",
    ptvIds: [1520],
    mapLocation: corridor.craigieburnToSeymour.pointAt(1, 8),
  }),
  new Station({
    id: station.DROUIN,
    name: "Drouin",
    ptvIds: [1521],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(6, 16),
  }),
  new Station({
  ...
  new Station({
    ...
    ptvIds: [1057],
    mapLocation: corridor.camberwellToRingwood.pointAt(1, 11),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Garfield",
    ptvIds: [1526],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(3, 16),
  }),
  new Station({
    id: station.GEELONG,
    name: "Geelong",
  ...
  new Station({
    ...
    ptvIds: [1529],
    mapLocation: corridor.craigieburnToSeymour.pointAt(3, 8),
  }),
  new Station({
    id: station.HEATHERDALE,
    name: "Heatherdale",
    ptvIds: [1091],
    mapLocation: corridor.camberwellToRingwood.pointAt(10, 11),
  }),
  new Station({
  ...
  new Station({
    id: station.HUGHESDALE,
    name: "Hughesdale",
    ptvIds: [1098],
    mapLocation: corridor.caulfieldToClayton.pointAt(3, 6),
  }),
  new Station({
    id: station.HUNTINGDALE,
    name: "Huntingdale",
    ptvIds: [1099],
  ...
  new Station({
    ...
    name: "Kangaroo Flat",
    ptvIds: [1530],
    mapLocation: corridor.sunburyToBendigo.pointAt(9, 10),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Kyneton",
    ptvIds: [1533],
    mapLocation: corridor.sunburyToBendigo.pointAt(6, 10),
  }),
  new Station({
    id: station.LABURNUM,
    name: "Laburnum",
    ptvIds: [1111],
    mapLocation: corridor.camberwellToRingwood.pointAt(6, 11),
  }),
  new Station({
    id: station.LALOR,
    name: "Lalor",
  ...
  new Station({
    ...
    name: "Macedon",
    ptvIds: [1537],
    mapLocation: corridor.sunburyToBendigo.pointAt(4, 10),
  }),
  new Station({
    id: station.MACLEOD,
    name: "Macleod",
  ...
  new Station({
    id: station.MALMSBURY,
    name: "Malmsbury",
    ptvIds: [1538],
    mapLocation: corridor.sunburyToBendigo.pointAt(7, 10),
  }),
  new Station({
    id: station.MALVERN,
    name: "Malvern",
  ...
  new Station({
    ...
    name: "Mitcham",
    ptvIds: [1128],
    mapLocation: corridor.camberwellToRingwood.pointAt(9, 11),
  }),
  new Station({
    id: station.MOE,
    name: "Moe",
    ptvIds: [1540],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(10, 16),
  }),
  new Station({
  ...
  new Station({
    id: station.MOOROOPNA,
    name: "Mooroopna",
    ptvIds: [1541],
    mapLocation: corridor.seymourToShepparton.pointAt(3, 4),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Morwell",
    ptvIds: [1542],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(11, 16),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Murchison East",
    ptvIds: [1543],
    mapLocation: corridor.seymourToShepparton.pointAt(2, 4),
  }),
  new Station({
    id: station.MURRUMBEENA,
    name: "Murrumbeena",
    ptvIds: [1138],
    mapLocation: corridor.caulfieldToClayton.pointAt(2, 6),
  }),
  new Station({
    id: station.NAGAMBIE,
    name: "Nagambie",
    ptvIds: [1544],
    mapLocation: corridor.seymourToShepparton.pointAt(1, 4),
  }),
  new Station({
    id: station.NAR_NAR_GOON,
    name: "Nar Nar Goon",
    ptvIds: [1545],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(1, 16),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Newport",
    ptvIds: [1141],
    mapLocation: MapPoint.at(node.NEWPORT.NEWPORT),
  }),
  new Station({
    id: station.NOBLE_PARK,
    name: "Noble Park",
    ptvIds: [1142],
    mapLocation: corridor.claytonToDandenong.pointAt(4, 6),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "North Richmond",
    ptvIds: [1145],
    mapLocation: corridor.jolimontToCliftonHill.pointAt(2, 5),
  }),
  new Station({
  ...
  new Station({
    ...
    ptvIds: [1146],
    mapLocation: corridor.newportToWilliamstown.pointAt(1, 3),
  }),
  new Station({
  ...
  new Station({
    id: station.NUNAWADING,
    name: "Nunawading",
    ptvIds: [1148],
    mapLocation: corridor.camberwellToRingwood.pointAt(8, 11),
  }),
  new Station({
    id: station.OAK_PARK,
    name: "Oak Park",
  ...
  new Station({
    ...
    name: "Oakleigh",
    ptvIds: [1150],
    mapLocation: corridor.caulfieldToClayton.pointAt(4, 6),
  }),
  new Station({
    id: station.OFFICER,
    name: "Officer",
  ...
  new Station({
    ...
    name: "Riddells Creek",
    ptvIds: [1549],
    mapLocation: corridor.sunburyToBendigo.pointAt(2, 10),
  }),
  new Station({
    id: station.RINGWOOD,
    name: "Ringwood",
    ptvIds: [1163],
    mapLocation: MapPoint.at(node.BURNLEY.RINGWOOD),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Rosedale",
    ptvIds: [1551],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(13, 16),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Sale",
    ptvIds: [1553],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(14, 16),
  }),
  new Station({
    id: station.SANDOWN_PARK,
    name: "Sandown Park",
    ptvIds: [1172],
    mapLocation: corridor.claytonToDandenong.pointAt(3, 6),
  }),
  new Station({
    id: station.SANDRINGHAM,
    name: "Sandringham",
    ptvIds: [1173],
    mapLocation: MapPoint.at(node.SANDRINGHAM.SANDRINGHAM),
  }),
  new Station({
    id: station.SEAFORD,
    name: "Seaford",
  ...
  new Station({
    ...
    name: "Seddon",
    ptvIds: [1176],
    mapLocation: corridor.footscrayToNewport.pointAt(1, 4),
  }),
  new Station({
    id: station.SEYMOUR,
    name: "Seymour",
    ptvIds: [1554],
    mapLocation: MapPoint.at(node.REGIONAL_WESTERN.SEYMOUR),
  }),
  new Station({
    id: station.SHEPPARTON,
    name: "Shepparton",
    ptvIds: [1555],
    mapLocation: MapPoint.at(node.REGIONAL_WESTERN.SHEPPARTON),
  }),
  new Station({
  ...
  new Station({
    ...
    ptvIds: [1179],
    mapLocation: corridor.northMelbourneToFootscray.pointAt(1, 2),
  }),
  new Station({
  ...
  new Station({
    id: station.SPOTSWOOD,
    name: "Spotswood",
    ptvIds: [1182],
    mapLocation: corridor.footscrayToNewport.pointAt(3, 4),
  }),
  new Station({
  ...
  new Station({
    id: station.SPRINGVALE,
    name: "Springvale",
    ptvIds: [1183],
    mapLocation: corridor.claytonToDandenong.pointAt(2, 6),
  }),
  new Station({
  ...
  new Station({
    id: station.STONY_POINT,
    name: "Stony Point",
    ptvIds: [1185],
    mapLocation: MapPoint.at(node.STONY_POINT.STONY_POINT),
  }),
  new Station({
    id: station.STRATFORD,
    name: "Stratford",
    ptvIds: [1558],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(15, 16),
  }),
  new Station({
  ...
  new Station({
    id: station.SWAN_HILL,
    name: "Swan Hill",
    ptvIds: [1559],
    mapLocation: MapPoint.at(node.REGIONAL_WESTERN.SWAN_HILL),
  }),
  new Station({
    id: station.SYNDAL,
    name: "Syndal",
  ...
  new Station({
    ...
    name: "Talbot",
    ptvIds: [1594],
    mapLocation: corridor.ballaratToMaryborough.pointAt(3, 4),
  }),
  new Station({
    id: station.TALLAROOK,
    name: "Tallarook",
    ptvIds: [1560],
    mapLocation: corridor.craigieburnToSeymour.pointAt(7, 8),
  }),
  new Station({
    id: station.TARNEIT,
    name: "Tarneit",
  ...
  new Station({
    ...
    name: "Trafalgar",
    ptvIds: [1562],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(9, 16),
  }),
  new Station({
    id: station.TRARALGON,
    name: "Traralgon",
    ptvIds: [1563],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(12, 16),
  }),
  new Station({
    id: station.TYABB,
    name: "Tyabb",
  ...
  new Station({
    ...
    name: "Tynong",
    ptvIds: [1564],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(2, 16),
  }),
  new Station({
    id: station.UPFIELD,
    name: "Upfield",
    ptvIds: [1198],
    mapLocation: MapPoint.at(node.NORTHERN.UPFIELD),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Victoria Park",
    ptvIds: [1201],
    mapLocation: corridor.jolimontToCliftonHill.pointAt(4, 5),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Wallan",
    ptvIds: [1574],
    mapLocation: corridor.craigieburnToSeymour.pointAt(2, 8),
  }),
  new Station({
    id: station.WANDONG,
    name: "Wandong",
    ptvIds: [1566],
    mapLocation: corridor.craigieburnToSeymour.pointAt(4, 8),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Warragul",
    ptvIds: [1568],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(7, 16),
  }),
  new Station({
    id: station.WARRNAMBOOL,
    name: "Warrnambool",
    ptvIds: [1569],
    mapLocation: MapPoint.at(node.REGIONAL_WESTERN.WARRNAMBOOL),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Werribee",
    ptvIds: [1205],
    mapLocation: MapPoint.at(node.NEWPORT.WERRIBEE),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "West Richmond",
    ptvIds: [1207],
    mapLocation: corridor.jolimontToCliftonHill.pointAt(1, 5),
  }),
  new Station({
    id: station.WESTALL,
    name: "Westall",
    ptvIds: [1208],
    mapLocation: corridor.claytonToDandenong.pointAt(1, 6),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Williamstown",
    ptvIds: [1211],
    mapLocation: MapPoint.at(node.NEWPORT.WILLIAMSTOWN),
  }),
  new Station({
    id: station.WILLIAMSTOWN_BEACH,
    name: "Williamstown Beach",
    ptvIds: [1212],
    mapLocation: corridor.newportToWilliamstown.pointAt(2, 3),
  }),
  new Station({
    id: station.WILLISON,
    name: "Willison",
  ...
  new Station({
    ...
    name: "Woodend",
    ptvIds: [1572],
    mapLocation: corridor.sunburyToBendigo.pointAt(5, 10),
  }),
  new Station({
  ...
  new Station({
    ...
    name: "Yarragon",
    ptvIds: [1573],
    mapLocation: corridor.eastPakenhamToBairnsdale.pointAt(8, 16),
  }),
  new Station({
    id: station.YARRAMAN,
    name: "Yarraman",
    ptvIds: [1215],
    mapLocation: corridor.claytonToDandenong.pointAt(5, 6),
  }),
  new Station({
    id: station.YARRAVILLE,
    name: "Yarraville",
    ptvIds: [1216],
    mapLocation: corridor.footscrayToNewport.pointAt(2, 4),
  }),
  new Station({
    id: station.HUNTLY,
    name: "Huntly",
  ...
  new Station({
    ...
    name: "Union",
    ptvIds: [1229],
    mapLocation: corridor.camberwellToRingwood.pointAt(4, 11),
  }),
  new Station({
